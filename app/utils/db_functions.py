...
async def db_check_token_users(user: JWTUser):
...
async def db_insert_personel(user: User):
    query = """insert into personel(username, password, mail, role) values (:name, :password, :mail, :role)"""
    values = dict(user)
